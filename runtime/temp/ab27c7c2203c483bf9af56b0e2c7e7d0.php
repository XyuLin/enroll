<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:72:"C:\Work\Code\sub\public/../application/common\view\tpl\dispatch_jump.tpl";i:1553754295;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="system-message <?php echo $codeText; ?>">
    <div class="image">
        <img src="/sub/public/assets/img/<?php echo $codeText; ?>.svg" alt="" width="150" />
    </div>
    <h1><?php echo $msg; ?></h1>
    <?php if($url): ?>
        <p class="jump">
    ...
    <?php endif; ?>
    <p class="clearfix">
        <a href="/sub/public/" class="btn btn-grey"><?php echo __('Go back'); ?></a>
        <?php if($url): ?>
